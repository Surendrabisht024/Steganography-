...
# Load cover image
img = cv2.imread("berserk.jpg")  # Ensure this image exists in your working directory
if img is None:
...
os.system("start encrypted_image.png")  # For Windows; on macOS use 'open' and on Linux 'xdg-open'
